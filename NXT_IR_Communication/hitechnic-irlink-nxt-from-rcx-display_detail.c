  	...
  	newValue =
		...
		if (newValue == lastValue) {
			...
			if(msg[6] != 0 && msg[6] < 100) {
	  		...
	  		eraseDisplay();
		  	playSound(soundBlip);
		  	displayTextLine(2, "%d", msg[4]);
		  	displayTextLine(3, "%d", msg[5]);
			  displayTextLine(4, "%d", msg[6]);
			  displayTextLine(5, "%d", msg[7]);
			  displayTextLine(6, "%d", msg[8]);
			  displayTextLine(7, "%d", msg[9]);
			}
			else {
				eraseDisplay();
		  	playSound(soundBlip);
